...
REGOLA SU ANNUNCI E CHIUSURE: molte attività iniziano con un annuncio esplicito prima di cominciare davvero — "ora guardiamo una reaction a...", "proviamo a giocare a...", "vediamo questo video che mi hanno mandato". Quando senti un annuncio così, quello segna l'inizio del segmento (l'attività comincia lì, non in un momento "più interessante" dentro di essa che ti sembra un punto di partenza migliore). Allo stesso modo, un'attività NON finisce quando si distraggono un attimo, commentano una cosa diversa per una battuta, guardano la chat, o fanno una pausa breve nel mezzo — finisce SOLO quando la lasciano DAVVERO e in modo definitivo: chiudono la pagina/il video/l'app che stavano guardando, smettono di giocare a QUEL gioco specifico, o cambiano argomento di discussione senza più tornarci. Se dopo una battuta o una breve distrazione tornano alla stessa reaction/allo stesso gioco/allo stesso discorso, quella distrazione NON è la fine — il segmento continua fino alla chiusura vera e definitiva. Vale per le reaction, per i giochi, per qualunque attività: la domanda da farsi non è "cosa stanno facendo in questo istante" ma "hanno chiuso per sempre questa cosa specifica, o ci torneranno ancora?".

ERRORE DA NON RIPETERE #3 (osservato ripetutamente in pratica): molte clip iniziano con l'attività già a metà — il gioco già in corso da un po', la reaction già iniziata da minuti — perché il caricamento/l'apertura/il lancio DELL'ATTIVITÀ STESSA viene scambiato per "tempo morto da saltare". NON lo è: l'annuncio ("ora guardiamo..."), il tempo di apertura del video/caricamento del gioco, e le prime battute di commento SONO l'inizio dell'attività, vanno DENTRO il segmento. Il "tempo morto" da saltare è un'altra cosa: silenzi lunghi PRIMA che qualcuno annunci qualcosa, problemi tecnici scollegati dall'attività (crash, disconnessioni), chiacchiere senza argomento che non anticipano nulla. Nel dubbio se un momento è "setup dell'attività" o "tempo morto scollegato", chiediti: questo momento fa parte del lanciare/iniziare la cosa che segue, o è totalmente estraneo ad essa? Se fa parte del lancio, resta dentro anche se per qualche secondo non succede ancora nulla di "interessante".

Altre regole:
- Ogni segmento deve avere un inizio e una fine naturali: comincia quando l'attività comincia DAVVERO (annuncio/lancio incluso, vedi sopra), finisce quando cambia DAVVERO argomento/gioco/attività/formato. Se un'attività comincia prima dell'inizio della finestra che ti è stata data o continua oltre la fine, usa comunque i timestamp REALI disponibili nel transcript fornito (non inventarli), anche se il segmento risulta parziale — verrà eventualmente unito a quello della finestra successiva.
- Salta SOLO i momenti morti scollegati da qualunque attività: silenzi lunghi prima che venga annunciato qualcosa, problemi tecnici, chiacchiere senza argomento riconoscibile. Il caricamento/l'apertura/il lancio di un'attività appena annunciata NON è tempo morto (vedi ERRORE #3) — non spezzare un'attività a metà solo perché per un minuto non succede nulla di eclatante.
