...
function formatAliasGlossary(): string {
  return Object.entries(STREAMER_ALIASES)
...
Alias per i titoli — usa SEMPRE questi al posto del nome reale quando riconosci una di queste persone (anche se nel transcript il nome compare storpiato dalla trascrizione automatica, riconoscilo comunque per assonanza):
${formatAliasGlossary()}
